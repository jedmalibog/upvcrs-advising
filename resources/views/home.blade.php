        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <h7>{{ Auth::user()->id }}</h7> <br>
                    <h7>{{ Auth::user()->name }}</h7> <br>
                    <h7>{{ Auth::user()->degree_program }}</h7> <br>
                    <h7>{{ Auth::user()->degree_level }}</h7> <br>
                    <h7>{{ Auth::user()->year_level }}</h7> <br>  
                </div>
            </div>
        </div>
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="list-group">
                        ...
                        <a href="/advising/{{ Auth::user()->id }}" class="list-group-item">Advising</a>
