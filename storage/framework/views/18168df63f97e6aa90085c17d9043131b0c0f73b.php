...
<div class="container">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('bdate') ? ' has-error' : ''); ?>">
                            <label for="bdate" class="col-md-4 control-label">Birthday</label>

                            <div class="col-md-6">
                                <input id="bdate" type="date" class="form-control" name="bdate" value="<?php echo e(old('bdate')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('phone_number') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="tel" class="form-control" name="phone_number" value="<?php echo e(old('phone_number')); ?>" required autofocus>
                       ...
                       <!--  <div class="form-group<?php echo e($errors->has('degree_program') ? ' has-error' : ''); ?>">
                            <label for="degree_program" class="col-md-4 control-label">Degree Program</label>

                            <div class="col-md-6">
                                <input id="degree_program" type="phone_numb" class="form-control" name="degree_program" value="<?php echo e(old('degree_program')); ?>" required autofocus>
 ...
 -->
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="degree_program" class="form-control" value="<?php echo e(old('degree_program')); ?>" required autofocus>
                                ...
                                <?php if($errors->has('degree_program')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('degree_program')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="degree_level" class="form-control" value="<?php echo e(old('degree_level')); ?>" required autofocus>
                                    <option>Secondary</option>
                                    <option>Undergraduate</option>
                                    <option>Graduate</option>
                                </select>
                                <?php if($errors->has('degree_level')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('degree_level')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="year_level" class="form-control" value="<?php echo e(old('year_level')); ?>" required autofocus>
                                ...
                                <?php if($errors->has('year_level')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('year_level')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
